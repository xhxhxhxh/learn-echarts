<template>
    <div class="OrderMap-container" ref="OrderMap" style="height: 500px"></div>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            initEcharts () {
                this.chart = this.$echarts.init(this.$refs.OrderMap)
            },

            loadChart () {
                this.$axios.get('https://www.youbaobao.xyz/datav-res/datav/map.json').then(res => {
